...
(function(factory, undefined) {
    ...
    */
    ...
    var copyright = 'Copyright (c) 2022 Nicholas W. Heyer ' +
        '<https://heyer.app>';
    var version_string = version_set ? 'v. ' + $.terminal.version : ' ';
    // regex is for placing version string aligned to the right
    var reg = new RegExp(' {' + version_string.length + '}$');
    var name_ver = 'HeyerApp Terminal Emulator' +
        (version_set ? version_string : '');
    // -----------------------------------------------------------------------
    // :: Terminal Signatures
    // -----------------------------------------------------------------------
    var signatures = [
        ['HeyerApp Terminal', '(c) 2022 nheyer'],
        ...
        [
            ...
            '|/__\\|/__\\|/__\\|/__\\|/__\\|/__\\|/__\\|/__\\|\t' + version_string,
            copyright
